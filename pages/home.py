...
st.write('🔴 Filtragem e ordenação de dados (```WHERE```, ```ORDER BY```, ```GROUP BY```)')
...
st.write('🟡 Subconsultas e Common Table Expressions (CTEs)')
...
st.write('🟢 Integridade referencial e transações')
...
st.write('🔵 Projetos práticos para melhorar suas habilidades')
...
# st.markdown('''💡 :blue[Aprimore suas habilidades e torne-se um mestre do SQL com o Mundo SQL!] 🚀''')
...
st.markdown('<p class="big-font">💡 Aprimore suas habilidades e torne-se um mestre do SQL com o Mundo SQL! 🚀</p>', unsafe_allow_html=True)
